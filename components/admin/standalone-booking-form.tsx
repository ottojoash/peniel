...
// Hardcoded room options to avoid database fetch
const ROOM_OPTIONS = [
...
export default function StandaloneBookingForm() {
  ...
  const selectedRoom = ROOM_OPTIONS.find((room) => room.id.toString() === roomId)
  ...
  const totalAmount = nights * 100 // $100 per night
  ...
  const validateForm = () => {
    ...
    if (!guestPhone) newErrors.guestPhone = "Guest phone is required"
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="guestPhone" className={errors.guestPhone ? "text-destructive" : ""}>
                      Phone Number *
                    </Label>
                    <Input
                      id="guestPhone"
