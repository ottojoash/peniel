              ...
              <div className="mb-8">
                <Tabs defaultValue="all" className="w-full">
                  ...
                  <TabsContent value="all" className="mt-6">
                    <GalleryGrid photos={photos.all} />
                  </TabsContent>

                  <TabsContent value="hotel" className="mt-6">
                    <GalleryGrid photos={photos.hotel} />
                  </TabsContent>

                  <TabsContent value="rooms" className="mt-6">
                    <GalleryGrid photos={photos.rooms} />
                  </TabsContent>

                  <TabsContent value="restaurant" className="mt-6">
                    <GalleryGrid photos={photos.restaurant} />
                  </TabsContent>

                  <TabsContent value="amenities" className="mt-6">
                    <GalleryGrid photos={photos.amenities} />
                  </TabsContent>

                  <TabsContent value="kids-park" className="mt-6">
                    <GalleryGrid photos={photos["kids-park"]} />
                  </TabsContent>

                  <TabsContent value="beach" className="mt-6">
                    <GalleryGrid photos={photos.beach} />
                  </TabsContent>

                  <TabsContent value="events" className="mt-6">
                    <GalleryGrid photos={photos.events} />
                  </TabsContent>
                </Tabs>
              </div>
            </TabsContent>
